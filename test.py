...
def compute(targets):
    for target in targets:
        for shift in [3]:
            simulator = Simulator(dt_from='2016-10-24 12:00', dt_to='2016-10-26 12:30', target=target, shift=shift, fit_model=True,
                                  datasource_path=datasource_path, ticks_to_shift=[0, 1, 2, 3, 4, 5, 10, 20, 30, 40, 50], verbose=True)
